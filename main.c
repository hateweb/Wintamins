...
tab tabs[] = {
	{"General", NULL, IDD_GENERAL},
	{"Mouse", NULL, IDD_MOUSE},
...
void apply_config()
{
	...
	add_to_autostart = IsDlgButtonChecked(hwnd_general, IDC_AUTOSTART) == BST_CHECKED;
	autostart_as_admin =
...
void revert_config()
{
	...
	CheckDlgButton(
		hwnd_general, IDC_AUTOSTART, add_to_autostart ? BST_CHECKED : BST_UNCHECKED);
